...
# Set default application name and make sure we got extension
ifndef APPNAME
APPNAME = cvstrac$(E)
else
override APPNAME := $(APPNAME:$(E)=)$(E)
endif
...
makecss:	$(SRCDIR)/makecss.c
	$(BCC) -o makecss $(SRCDIR)/makecss.c
...
css_.c:	$(SRCDIR)/css.c $(SRCDIR)/VERSION translate
	./translate $(SRCDIR)/css.c | sed -f $(SRCDIR)/VERSION >css_.c

css.o:	css_.c css.h  $(SRCDIR)/config.h
	$(XTCC) -o css.o -c css_.c
